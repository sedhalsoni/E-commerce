								...
								<div class='row'>
									<div class='col-sm-12 height-contact-element'>
										<div class='form-group'>
											<input type='text' name='name' value='$row[1]' class='form-control custom-labels' id='name' placeholder='Category Name' required data-validation-required-message='Please write category Name!'/>
											<p class='help-block text-danger'></p>
										</div>
									</div>
									<div class='col-sm-3 col-xs-6 height-contact-element'>
										<div class='form-group'>
											<input type='submit' name='Edit' class='btn btn-md btn-custom btn-noborder-radius' value='Edit category'/>
										</div>
									</div>
									<div class='col-sm-3 col-xs-6 height-contact-element'>
										<div class='form-group'>
